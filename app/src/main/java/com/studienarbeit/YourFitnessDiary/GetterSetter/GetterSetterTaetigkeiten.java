...
public class GetterSetterTaetigkeiten {
    ...
    public String getVerbrKcal() {
        return verbrKcal;
    }

    public void setVerbrKcal(String verbrKcal) {
        this.verbrKcal = verbrKcal;
    }
    ...
    public GetterSetterTaetigkeiten(int mainTaetID, String taetBeschreibung, String verbrKcal,
                                    String laenge, String startzeit, int newMainTaetID) {
        this.mainTaetID = mainTaetID;
        this.taetBeschreibung = taetBeschreibung;
        this.verbrKcal = verbrKcal;
        this.laenge = laenge;
